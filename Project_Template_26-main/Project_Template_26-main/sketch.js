...
function handlePlayerArrowCollision() {
 ...
 // console.log("player arrow collided enter")
...
function handleComputerArrowCollision() {
 // console.log("computer arrow collided enter")
  ...
  for(i = 0; i < playerArrows.length; i++){
    ...
    var Archer2Collision = Matter.SAT.collides(
      computerArrows[i].body,
      playerArcher.body
    )
    ...
    if(
      base2Collision.collided||
      Archer2Collision.collided||
